...
A previous [final-price calibration study](/guides/kalshi-political-prediction-market-accuracy) looked at final traded prices and tested whether [Are 90% prediction markets reliable?](/guides/kalshi-political-prediction-market-accuracy) — specifically whether the expected “90% trap” showed up near resolution.

That [Kalshi political market calibration](/guides/kalshi-political-prediction-market-accuracy) analysis found that the trap did not appear.

Final high-confidence political markets were highly reliable at the extremes.

See the related analysis here:

[Are 90% prediction markets reliable? A Kalshi political calibration study](/guides/kalshi-political-prediction-market-accuracy)
...
<PublicChart username="misterrpink" slug="calibration-market-open" />

<PublicChart username="misterrpink" slug="calibration-market-close" />
...
<PublicChart username="misterrpink" slug="markets-by-bucket" />
...
<PublicChart username="misterrpink" slug="political-market-convergence-examples" />
