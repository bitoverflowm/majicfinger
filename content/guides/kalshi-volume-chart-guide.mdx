...
> **How to actually build those volume charts yourself using historical data in [Lychee](https://lycheedata.com)**
...
<KalshiHistoricalDataQuery
  title="Make a request on Kalshi trade data now"
  description="Select Trades, pick the columns you need for volume analysis, and run your query — then continue with the step-by-step chart guide below."
/>
...
<PublicChart username="misterrpink" slug="kalshi-quaterly-volume-chart" />
