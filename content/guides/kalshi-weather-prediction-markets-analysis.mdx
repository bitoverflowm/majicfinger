...
Using [Lychee](lycheedata.com): We can break Kalshi weather markets into three measurable layers: pricing dynamics, calibration accuracy, and volatility structure.
