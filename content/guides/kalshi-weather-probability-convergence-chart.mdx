...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/7.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/8.png)
...
- Select `Select All`: to select all columns in the `TRADES` data base:
    ...
    - `_fetched_at`: this is a meta meetric when the data was pulled by Lychee. You can mostly ignore it.

![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/9.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/10.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/11.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/12.png)

- Select `Stats` → `BUCKET`

![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/13.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/14.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/15.png)
...
## Step 11 — Interpret convergence (Building Chart)

- Select `charts` from the tabs above `Data Sheet` or above the right Side Panel

![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/16.png)
...
![Create API connection screen](/images/guides/kalshi-weather-probability-convergence-chart/17.png)
