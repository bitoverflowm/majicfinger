...
coverImage: "/images/guides/polymarket-live-price-charts/main.png"
featured: true
---
...
Inside the integrations playground, select the **Live** data option.

This allows Lychee to subscribe to Polymarket’s real-time market stream.

*(Insert screenshot)*

---

## 3. Select the Market Data Stream
...
## 5. Start the Live Data Connection
