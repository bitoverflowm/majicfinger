...
title: "How to Find a Polymarket Market ID, Token ID, Asset ID & Condition ID"
description: "Learn how to find Polymarket market IDs, token IDs, asset IDs, condition IDs, slugs, and clobTokenIds for API queries, price history, orderbooks, and market analysis."
...
seoTitle: "How to Find a Polymarket Market ID, Token ID, Asset ID & Condition ID"
...
- [Polymarket Gamma API Events Slug](/guides/polymarket-gamma-api-events-slug) — query an event by slug and extract market IDs, condition IDs, and clobTokenIds
- [Use the Polymarket CLOB WebSocket market channel](/guides/polymarket-clob-websocket-market-channel)
- [Polymarket Metadata Lookup](/polymarket-metadata) — search events and markets by name, slug, or ID without writing API calls
...
<PublicChart username="misterrpink" slug="2026-nba-champion" />
...
Once you have the identifiers, [inspect Polymarket order books](/polymarket-live-data#polymarket-order-book) and other live views without leaving Lychee.
