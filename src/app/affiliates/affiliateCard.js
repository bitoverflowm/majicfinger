...
export function AffiliateCard() {
  ...
  return (
    <div className="relative h-full w-full max-w-[32rem] transform-gpu rounded-lg border bg-black [border:1px_solid_rgba(255,255,255,.1)] [box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] md:max-h-[500px]">
      ...
      >
        <Link rel="noopener noreferrer" target="_blank" href="https://lych3e.promotekit.com/">
        ...
        <div className="flex w-full flex-col items-start border-t p-4 border-neutral-800">
          <h2 className="text-lychee_white text-xl font-semibold">Earn 20% every time someone your refer signs up</h2>
          <p className="text-base font-normal text-neutral-400">
            All you gotta do is click here, sign up and start referring people to Lychee!
          </p>
        </div>
        </Link>
      </motion.div>
