...
const SideNav = () => {
  ...
  return (
    ...
    <div className="mt-auto mb-5 w-full">
        {
          minimized ? <Link href={'/#getIt'}><div className="bg-purple-600 flex place-items-center place-content-center p-2 rounded-sm text-white hover:bg-yellow-400 cursor-pointer hover:text-purple-600"><PowerIcon /> </div></Link>
                  : <Link href={'/#getIt'}><Card>
                      ...
                      <CardContent className="w-full text-[10px] pt-2">
                        <div className="text-sm text-center flex place-items-center place-content-center gap-1">
                          $39.99 <div className="line-through text-[10px] text-center">$199.99/month</div>
                        </div>
