          ...
          <AnimatePresence>
            ...
            {selectedId === "event_candlesticks" ? (
              <>
                ...
                <KalshiLiveCandlestickCommonQueries className="mt-4 pb-2" disabled={pullLoading} />
                <KalshiLiveEventCandlesticksRealtimeFeed className="mt-4" disabled={pullLoading} />
              </>
            ) : null}
            ...
            {selectedId === "trades" ? (
              <>
                ...
                <KalshiLiveTradesRealtimeFeed className="mt-4" disabled={pullLoading} />
              </>
            ) : null}
            ...
            {selectedId === "series" ? (
              <KalshiLiveSeriesTickersField
                className="mt-4"
                value={connectKalshiLiveSeriesTicker}
                onChange={(v) => setConnectKalshiLiveSeriesTicker?.(v)}
                disabled={pullLoading}
              />
            ) : null}
            <ColumnPicker
