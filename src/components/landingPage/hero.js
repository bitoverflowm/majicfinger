    ...
    return (
        <section id="hero" className="flex place-content-center w-11/12 mx-auto overflow-hidden">
            <div className="relative h-full container z-10 flex flex-col overflow-hidden">
                <Meteors />
                <div className="text-balance bg-gradient-to-br from-lychee_blue from-0% to-lychee_red/70 bg-clip-text font-black leading-none tracking-tighter text-transparent pt-10 pb-3 sm:py-10 text-7xl lg:text-[250px] text-center sm:text-left">
                    Lychee<span className="text-lychee_red pl-1 sm:pl-4" style={{ textShadow: '0px 0px 50px rgba(169, 29, 58, 1)'}}>.</span>
                </div>
                <div className="text-center sm:text-left sm:pl-6 text-xl sm:text-6xl text-white">Easy <span className="text-lychee_green italic font-black ">Peasy</span> Data...</div>
                <div className="pt-10 sm:pt-20 sm:pr-20">
                    ...
                    <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Not A Single Line of Code Required on Your End</div>
                    <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Data Cleaner Than a Nun's Browser History</div>
                ...
                <div className="sm:grid sm:grid-cols-10 gap-4 w-full sm:pt-48">
                    <div className="sm:col-span-5 sm:pt-40">
                            <BlurIn
                                word="BRING YOUR DATA TO LIFE With"
                                className="text-2xl sm:text-8xl text-lychee_green font-black py-10 pb-5"
                            />
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">A Powerful Spreadsheet</div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">MindBendingly Beautiful Visualizations and Charts </div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">A Rich Text Editor </div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Generate Stunning presentations </div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Deploy an entire website right here </div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Publish Your Findings</div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Share Your Discoveries on Social Media</div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Invite Your Team</div>
                            <div className="pt-4 text-center text-lychee_white text-xl sm:text-4xl">Build an Audience Right Here</div>                                  
                    </div>
