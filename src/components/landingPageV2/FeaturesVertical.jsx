      ...
      <div className="container">
        <div className="max-w-6xl mx-auto">
          <div className="mx-auto my-12 h-full grid lg:grid-cols-2 gap-10 items-center">
                ...
                {data.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center relative">
                      ...
                      <AccordionTrigger className="flex flex-col items-start text-left pl-0">
                        <span className="text-xl font-bold">{item.title}</span>
                        <span className="text-[16px] font-normal leading-4 text-muted-foreground mt-1">
                          {item.content}
                        </span>
                      </AccordionTrigger>
                    </div>
            ...
            <ul
              ref={carouselRef}
              className="flex h-full snap-x flex-nowrap overflow-x-auto py-10 [-ms-overflow-style:none] [-webkit-mask-image:linear-gradient(90deg,transparent,black_20%,white_80%,transparent)] [mask-image:linear-gradient(90deg,transparent,black_20%,white_80%,transparent)] [scrollbar-width:none] lg:hidden snap-mandatory [&::-webkit-scrollbar]:hidden"
