    ...
    content: (
      <>
        ...
        <Safari
          ...
          url="https://lycheedata.com"
          className="-mb-48 ml-12 mt-16 w-[1500px] h-full px-4 select-none drop-shadow-[0_0_28px_rgba(0,0,0,.1)] group-hover:translate-x-[-10px] transition-all duration-300"
        />
      </>
    ),
  },
