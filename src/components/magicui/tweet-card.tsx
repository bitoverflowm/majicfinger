...
export const TweetSkeleton = ({
  ...
  <div
    className={cn(
      "flex size-full max-h-max min-w-72 flex-col gap-2 rounded-xl border border-border bg-background p-4 dark:bg-card",
      className
    )}
    {...props}
  >
...
export const TweetNotFound = ({
  ...
  <div
    className={cn(
      "flex size-full flex-col items-center justify-center gap-2 rounded-lg border border-border bg-background p-4 text-foreground dark:bg-card",
      className
    )}
    {...props}
  >
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-fit w-full max-w-lg flex-col gap-4 overflow-hidden rounded-xl border border-border bg-background p-5 text-foreground shadow-sm dark:bg-card",
        className
      )}
      {...props}
    >
