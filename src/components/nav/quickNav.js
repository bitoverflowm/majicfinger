...
const QuickNav = () => {
    ...
    return (
        <div className='hidden lg:block fixed top-15 right-10 z-30 bg-white/30 rounded-xl px-8 py-5 text-lychee-black shadow-2xl flex flex-col gap-2 text-xs backdrop-blur-2xl place-items-center'>
            {
                user ? 
