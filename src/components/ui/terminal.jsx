...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "z-0 flex h-full min-h-0 w-full max-w-none flex-col overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-sm",
        className
      )}>
      <div className="flex shrink-0 flex-col gap-y-2 border-b border-border p-3">
      ...
      <pre className="min-h-0 flex-1 overflow-y-auto p-3">
