...
export const StateProviderV2 = ({children, initialSettings}) => {
    ...
    const [dataLakeComposeLimitScope, setDataLakeComposeLimitScope] = useState("primary");
