...
export const StateProviderV2 = ({children, initialSettings}) => {
    ...
    /** Connect home: which refine operation inline panel is open (where | join | sort | …). */
    const [connectActiveComposeOp, setConnectActiveComposeOp] = useState(null);
