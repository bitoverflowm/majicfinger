...
export const StateProviderV2 = ({children, initialSettings}) => {
    ...
    /** Shown when sidebar or canvas page title field is focused (formatting dock). */
    const [pageTitleFormatDockOpen, setPageTitleFormatDockOpen] = useState(false)
