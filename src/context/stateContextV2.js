...
export const StateProviderV2 = ({children, initialSettings}) => {
    ...
    const [connectPolymarketLiveSeriesCompose, setConnectPolymarketLiveSeriesCompose] = useState(
      /** @type {import("@/lib/polymarketLive/seriesCompose").PolymarketSeriesComposeState | null} */ (null),
    );
    ...
    const [connectPolymarketLiveEventVolumeCompose, setConnectPolymarketLiveEventVolumeCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/liveEventVolumeCompose").PolymarketLiveEventVolumeComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLiveSamplingMarketsCompose, setConnectPolymarketLiveSamplingMarketsCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/samplingMarketsCompose").PolymarketSamplingMarketsComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLiveOrderbooksCompose, setConnectPolymarketLiveOrderbooksCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/orderbooksCompose").PolymarketOrderbooksComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLiveMarketPricesCompose, setConnectPolymarketLiveMarketPricesCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/marketPricesCompose").PolymarketMarketPricesComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLiveMidpointPricesCompose, setConnectPolymarketLiveMidpointPricesCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/midpointPricesCompose").PolymarketMidpointPricesComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLiveSpreadsCompose, setConnectPolymarketLiveSpreadsCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/spreadsCompose").PolymarketSpreadsComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLiveLastTradePricesCompose, setConnectPolymarketLiveLastTradePricesCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/lastTradePricesCompose").PolymarketLastTradePricesComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLivePricesHistoryCompose, setConnectPolymarketLivePricesHistoryCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/pricesHistoryCompose").PolymarketPricesHistoryComposeState | null} */ (
          null
        ),
      );
    const [connectPolymarketLivePublicProfilesCompose, setConnectPolymarketLivePublicProfilesCompose] =
      useState(
        /** @type {import("@/lib/polymarketLive/publicProfilesCompose").PolymarketPublicProfilesComposeState | null} */ (
          null
        ),
      );
    ...
    const [dataLakeComposeRandomSampleEnabled, setDataLakeComposeRandomSampleEnabled] = useState(
      !!initialSettings?.dataLakeComposeRandomSampleEnabled,
    );
    const [dataLakeComposeRandomSampleSize, setDataLakeComposeRandomSampleSize] = useState(
      initialSettings?.dataLakeComposeRandomSampleSize ?? "",
    );
    const [dataLakeComposeRandomSampleSeeded, setDataLakeComposeRandomSampleSeeded] = useState(
      initialSettings?.dataLakeComposeRandomSampleSeeded !== false,
    );
    const [dataLakeComposeRandomSampleSeed, setDataLakeComposeRandomSampleSeed] = useState(
      initialSettings?.dataLakeComposeRandomSampleSeed ?? "",
    );
    ...
    const requestConnectWorkspace = useCallback((id, options) => {
      if (!id) {
        ...
        setConnectPolymarketLiveSeriesCompose(null);
        ...
        setConnectPolymarketLiveEventVolumeCompose(null);
        setConnectPolymarketLiveSamplingMarketsCompose(null);
        setConnectPolymarketLiveOrderbooksCompose(null);
        setConnectPolymarketLiveMarketPricesCompose(null);
        setConnectPolymarketLiveMidpointPricesCompose(null);
        setConnectPolymarketLiveSpreadsCompose(null);
        ...
        setDataLakeComposeRandomSampleEnabled(false);
        setDataLakeComposeRandomSampleSize("");
    ...
    const providerValue = useMemo(() => ({
        ...
        connectPolymarketLiveSeriesCompose, setConnectPolymarketLiveSeriesCompose,
