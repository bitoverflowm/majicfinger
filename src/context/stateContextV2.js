...
export const StateProviderV2 = ({children, initialSettings}) => {
    ...
    const setPageFormatDockTarget = useCallback((target) => {
      if (target === "pageTitle" || target === "pageSubheading") {
