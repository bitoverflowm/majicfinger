 ...
 */
export function useSyncConnectDataLakeComposeItems({
...
/** @deprecated Use useSyncConnectDataLakeComposeItems */
export const useSyncConnectKalshiComposeItems = useSyncConnectDataLakeComposeItems;
