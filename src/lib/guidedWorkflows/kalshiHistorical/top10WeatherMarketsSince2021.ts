...
export const top10WeatherMarketsSince2021Workflow: GuidedWorkflowDefinition = {
  ...
  steps: [
    ...
    {
      id: KALSHI_GUIDED_STEP_IDS.dataSheetLoaded,
      kind: "info",
      target: KALSHI_GUIDED_TARGETS.dataSheet,
      title: "Are you ready to export your CSV?",
      body: "Your pull is complete. This is your data sheet — next we'll export these rows as a CSV file.",
      placement: "top",
      completeWhen: { type: "continue" },
      waitForTarget: true,
      blockTargetInteraction: true,
    ...
    {
      id: KALSHI_GUIDED_STEP_IDS.openExportPanel,
      target: KALSHI_GUIDED_TARGETS.exportButton,
      title: "Open Export",
      body: "Click on the Export button — this is used for data, charts, and publishing your dashboards.",
      placement: "left",
      completeWhen: { type: "click" },
      waitForTarget: true,
    },
    {
      id: KALSHI_GUIDED_STEP_IDS.exportCsv,
      target: KALSHI_GUIDED_TARGETS.exportCsv,
      title: "Export CSV",
      body: "Click on CSV to begin your export.",
      placement: "left",
      completeWhen: { type: "click" },
      waitForTarget: true,
    },
    {
      id: KALSHI_GUIDED_STEP_IDS.workflowComplete,
      kind: "info",
      target: KALSHI_GUIDED_TARGETS.dataSheet,
      title: "Congratulations!",
      body: "You went through a full no-code cycle of getting the top 10 weather markets on Kalshi since Kalshi's launch in 2021 — and you downloaded a CSV.",
      footerText: "Upgrade to Pro now and do much more with full access.",
      placement: "top",
      completeWhen: { type: "continue" },
      waitForTarget: true,
      blockTargetInteraction: false,
