...
export const top10WeatherMarketsSince2021Workflow: GuidedWorkflowDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      target: KALSHI_GUIDED_TARGETS.whereColumn,
      title: "Select Category",
      body: 'Choose Category from the dropdown menu. If a filter row is already open, confirm Category is selected in the column field.',
      placement: "bottom",
      completeWhen: {
        type: "state",
