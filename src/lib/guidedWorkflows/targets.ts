...
export const KALSHI_GUIDED_TARGETS = {
  ...
  sortColumn: "kalshi.compose.sort.column" as const,
  sortDirection: "kalshi.compose.sort.direction" as const,
  limitToggle: "kalshi.compose.limit.toggle" as const,
  limitSet: "kalshi.compose.limit.set" as const,
  limitValue: "kalshi.compose.limit.value" as const,
  wherePanel: "kalshi.compose.where.panel" as const,
