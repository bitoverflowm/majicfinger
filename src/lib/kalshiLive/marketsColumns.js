...
export const KALSHI_LIVE_MARKETS_COLUMNS = [
  ...
  { name: "volume_fp", type: "string", description: "Lifetime volume (fixed-point string)" },
  { name: "volume_24h_fp", type: "string", description: "24h volume (fixed-point string)" },
  { name: "open_interest_fp", type: "string", description: "Open interest (fixed-point string)" },
