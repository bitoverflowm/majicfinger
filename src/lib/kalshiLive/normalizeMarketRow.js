...
export function normalizeKalshiLiveMarketRow(raw) {
  ...
  return {
    ...
    status: str("status"),
    yes_bid_dollars: num("yes_bid_dollars"),
    yes_bid_size_fp: fp("yes_bid_size_fp"),
    yes_ask_dollars: num("yes_ask_dollars"),
    yes_ask_size_fp: fp("yes_ask_size_fp"),
    no_bid_dollars: num("no_bid_dollars"),
    no_ask_dollars: num("no_ask_dollars"),
    last_price_dollars: num("last_price_dollars"),
    ...
    notional_value_dollars: num("notional_value_dollars"),
    previous_yes_bid_dollars: num("previous_yes_bid_dollars"),
    previous_yes_ask_dollars: num("previous_yes_ask_dollars"),
    previous_price_dollars: num("previous_price_dollars"),
    ...
    settlement_value_dollars: num("settlement_value_dollars"),
