...
/**
 * Proxy GET /historical/markets/{ticker} — Get Market by ticker.
 *
 * @see https://docs.kalshi.com/llms.txt (Kalshi Historical Markets reference)
 */
export default async function handler(req, res) {
  ...
  const url = kalshiLiveUrl(`historical/markets/${encodeURIComponent(ticker)}`);
  try {
