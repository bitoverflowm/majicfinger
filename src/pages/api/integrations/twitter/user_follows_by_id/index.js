import { fetch_twitter_following_by_id } from '../twitter_helper';
...
export default async (req, res) => {
    try {
        ...
        let user_data = await fetch_twitter_following_by_id(handleId, userFields.join(','), thirdParam.join(','), expansions.join(','));
